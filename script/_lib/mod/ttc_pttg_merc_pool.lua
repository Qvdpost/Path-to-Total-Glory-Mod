...
local function init_merc_list()
    local mercenaries = {
        ...
        {"wh3_main_cth_veh_war_compass_0", "rare", 1, { military_groupings = {"wh3_main_cth"}, category = "war_machine", tier = nil, cost = 2 }},
        ...
        {"wh3_dlc23_chd_inf_hobgoblin_sneaky_gits", "special", 1, { military_groupings = {"wh3_dlc23_group_chaos_dwarfs","wh3_dlc24_group_labourer_rebels"}, category = "inf_melee", tier = nil, cost = 2 }},
