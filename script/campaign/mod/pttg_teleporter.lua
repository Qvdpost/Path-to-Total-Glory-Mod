...
function pttg_tele:teleport_to_random_region(character)
    local regions = {
    ...
    while x == -1 do
        ...
        while at_war_with[random_region_name] do
            random_region_name = regions[cm:random_number(#regions,1)]
        end
        distance = cm:random_number(6,1)
...
function pttg_tele:teleport_random_distance(character, distance_upper_bound)
    ...
    if not distance_upper_bound then
    ...
    local distance
    while x == -1 do
        distance = cm:random_number(200,1)
